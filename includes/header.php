...
<html lang="en">
  <head>
    ...
    <title>My Pets</title>
    <link rel="stylesheet" href="/Lab7/scss/css/bootstrap.css" />
    <link rel="stylesheet" href="/Lab7/scss/css/style.css" />
  </head>
  <body>
    <header class="mb-5">
        ...
        <div class="row">
          ...
          >
            <ul class="nav">
              ...
              <li class="nav-itm">
                <a href="/Lab7/php/behavior.php" class="nav-link text-bg-primary rounded-3">Behavior</a>
              </li>
              <li class="nav-itm">
